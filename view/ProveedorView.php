<?php
$titulo_pag='Administrar Proveedor';
          ...
          <form id="form-crear">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="id_prove" class="form-control" placeholder="Ingrese ID">
                </div>
              </div>
              <div class="form-group">
                <label>Nombre</label>
                <div class="input-group">
                  ...
                  <input type="text" id="nom_prove" class="form-control" placeholder="Ingrese nombre" required>
                </div>
            </div>    
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="card card-secondary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tablaProveedor" class="table table-bordered table-hover dataTable dtr-inline" role="grid"></table>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
